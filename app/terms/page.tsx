...
const sections = [
  {
    ...
    body: "By accessing our website or engaging WebSphereX for services, you agree to be bound by these Terms of Service and all applicable laws. If you do not agree with any part of these terms, you may not use our services. These terms apply to all clients, visitors, and anyone who accesses or uses our services.",
  },
  {
    num: "02",
    title: "Services We Provide",
    body: "WebSphereX provides software development, AI consulting, product strategy, and related technology services as described in individual project agreements and statements of work. The scope, timeline, and deliverables for each engagement are defined in a separate contract. These terms govern the general relationship; specific engagements are governed by their respective agreements.",
  },
  {
    num: "03",
    title: "Intellectual Property",
    body: "Upon full payment, clients receive ownership of all custom deliverables created specifically for their project. WebSphereX retains ownership of pre-existing tools, frameworks, methodologies, and general-purpose code libraries developed independently. Open-source components remain subject to their respective licences. Portfolio rights (to reference the project publicly) are retained by WebSphereX unless explicitly waived in writing.",
  },
  {
    num: "04",
    title: "Client Responsibilities",
    body: "Clients are responsible for providing accurate and complete information needed for project execution, timely feedback and approvals within agreed review windows, proper licensing for any third-party assets or tools provided to WebSphereX, and compliance with all applicable laws in their jurisdiction. Delays caused by late client input may affect timelines without constituting a breach by WebSphereX.",
  },
  {
    num: "05",
    title: "Payment Terms",
    body: "Payment schedules are defined in individual project agreements. Invoices are due within 14 days of issue unless otherwise agreed. Late payments may incur a 1.5% monthly interest charge. WebSphereX reserves the right to pause work on overdue accounts. Disputes about invoices must be raised in writing within 7 days of receipt.",
  },
  {
    num: "06",
    title: "Confidentiality",
    body: "Both parties agree to keep confidential all non-public information shared during the engagement, including business strategies, technical specifications, and client data. This obligation survives termination of the project agreement for a period of 3 years. WebSphereX will not disclose your project details without written consent, except as required by law.",
  },
  {
    num: "07",
    title: "Disclaimers & Limitation of Liability",
    body: "WebSphereX provides services on an 'as-is' basis and does not guarantee specific business outcomes. Our total liability for any claim arising from an engagement shall not exceed the total fees paid by the client in the preceding 3 months. We are not liable for indirect, consequential, or incidental damages. These limitations apply to the fullest extent permitted by law.",
  },
  {
    num: "08",
              ...
              <div className="relative">
                ...
                <Reveal delay={0.12}>
                  <p className="text-gray-500 text-sm leading-relaxed max-w-lg mx-auto mb-8 sm:mb-9">
                    Email us at <a href="mailto:legal@webspherex.com" className="text-[#0048ff] underline">legal@webspherex.com</a>. We&apos;d rather explain something upfront than have a misunderstanding later.
                  </p>
                </Reveal>
                <Reveal delay={0.18}>
