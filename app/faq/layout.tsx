...
const TITLE = "FAQ — WebSphereX Software & AI Development";
const DESCRIPTION =
  "Answers to common questions about WebSphereX's process, pricing, timelines, and technology stack.";
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "What makes WebSphereX different from other agencies?",
      acceptedAnswer: {
        "@type": "Answer",
