...
const categories = [
  {
    ...
    faqs: [
      ...
      { q: "What is an Offshore Development Center (ODC)?", a: "An ODC is a fully managed offshore engineering unit built around your product. WebSphereX sets up, operates, and — if required — transfers ownership of a dedicated team that works exclusively on your systems at 60% lower operating cost than comparable onshore capacity." },
    ],
  },
  {
  ...
  },
  {
    ...
    slug: "ai",
    faqs: [
      { q: "Are your engineers trained on AI tooling?", a: "Yes. Every engineer placed through WebSphereX uses modern AI tooling as a core part of how they work — not as a gimmick. This means more output per sprint, cleaner code, and faster turnaround on reviews and testing." },
      { q: "What technologies does WebSphereX specialize in?", a: "We work across React, Next.js, TypeScript, Node.js, FastAPI, Python, PostgreSQL, Supabase, OpenAI, AWS, Docker, and more. Our teams are matched to your stack specifically — not assigned generically." },
