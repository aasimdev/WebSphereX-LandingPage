        ...
        <div className="relative max-w-[1350px] mx-auto flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-20">
          ...
          <div className="flex-1 flex flex-col gap-5 sm:gap-6">
            {[
              ...
              "Email us at privacy@webspherex.com to request deletion of any data we hold.",
              ...
              <div className="relative">
                ...
                <Reveal delay={0.12}>
                  <p className="text-gray-500 text-sm leading-relaxed max-w-lg mx-auto mb-8 sm:mb-9">
                    Email <a href="mailto:privacy@webspherex.com" className="text-[#0048ff] underline">privacy@webspherex.com</a> and we&apos;ll send you a full list of every cookie and third-party service active on your session.
                  </p>
                </Reveal>
                <Reveal delay={0.18}>
