...
const SOCIALS = [
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/webspherex",
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "GitHub",
    href: "https://github.com/webspherex",
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="relative max-w-[1350px] mx-auto px-4 sm:px-6">
          ...
          <div className="flex-shrink-0 lg:w-[200px]">
            <div className="flex items-center gap-2 mb-3">
              <svg width="20" height="20" viewBox="0 0 28 28" fill="none">
                <polygon points="14,2 26,9 26,19 14,26 2,19 2,9" stroke="#0048ff" strokeWidth="1.5" fill="rgba(0,72,255,0.07)" />
                <circle cx="14" cy="14" r="3.5" fill="#0048ff" />
              </svg>
              <span className="font-bold text-[15px] text-[#0f1c3f] tracking-tight">
        ...
        <div className="border-t border-gray-100 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-400">
            © 2026 WebSphereX. All rights reserved.
          </p>
