...
const companyMenu = [
  { title: "About Us", desc: "Our story, mission, and the team behind WebSphereX.", href: "/about" },
    ...
    <div className="sticky top-0 z-50">
      ...
      >
        <div className="max-w-[1350px] mx-auto px-4 lg:px-0 py-4 flex items-center justify-between relative">
          <Link href="/" className="font-extrabold text-2xl text-[#0f1c3f] tracking-tight no-underline select-none">
