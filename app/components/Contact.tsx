        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 mb-10 sm:mb-14">
              <a href="mailto:hello@webspherex.com" className="flex items-center gap-4 group no-underline">
            ...
            <div className="flex flex-col gap-7">
              {[
                ...
                { title: "Media Inquiries", body: "For media-related questions or press inquiries, please contact us at media@webspherex.com." },
              ].map((item) => (
                <div key={item.title}>
