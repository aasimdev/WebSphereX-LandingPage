            ...
            <Reveal delay={0.18}>
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-5 border-t border-[#0048ff]/10">
                  <div className="w-9 h-9 rounded-xl bg-[#0048ff] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">WX</div>
                  <div>
                    <p className="text-sm font-semibold text-[#0f1c3f]">WebSphereX</p>
