...
const reviewers = [
  {
    ...
    quote: "WebSphereX elevated our entire frontend. A genuinely world-class team.",
  },
  {
    ...
    <div className="w-full flex flex-col" style={{ maxWidth: 300 }}>
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-gray-100 mb-2">
        <div className="relative">
          <img src={CHAT_TEAM.avatar} alt="WebSphereX" className="w-7 h-7 rounded-full object-cover" />
          <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-green-400 border-2 border-white rounded-full" />
        </div>
        <div>
          <p className="text-[11px] font-semibold text-[#0f1c3f] leading-none">WebSphereX</p>
...
const TICKETS: { id: string; title: string; priority: "High" | "Medium" | "Low"; tag: string }[] = [
  { id: "WSX-041", title: "Login redirect loop on Safari", priority: "High",   tag: "Bug"     },
  { id: "WSX-042", title: "Dashboard chart not loading",   priority: "Medium", tag: "Bug"     },
  { id: "WSX-043", title: "Add CSV export to reports",     priority: "Low",    tag: "Feature" },
];
