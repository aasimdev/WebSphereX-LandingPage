...
const sections = [
  ...
  },
  {
    ...
    body: "If you have questions about this Privacy Policy or how we handle your data, contact us at privacy@webspherex.com. We may update this policy periodically. The date at the top of this page reflects the most recent revision. Continued use of our services after changes are posted constitutes acceptance of the revised policy.",
  },
];
              ...
              <div className="relative">
                ...
                <Reveal delay={0.12}>
                  <p className="text-gray-500 text-sm leading-relaxed max-w-lg mx-auto mb-8 sm:mb-9">
                    Email us at <a href="mailto:privacy@webspherex.com" className="text-[#0048ff] underline">privacy@webspherex.com</a> and we&apos;ll respond within 2 business days — in plain English, not legalese.
                  </p>
                </Reveal>
                <Reveal delay={0.18}>
